...
const GoalDetails = ({ goal, open, onClose, dispatch, user }) => {
...
const AddNewGoal = ({ open, onClose, dispatch }) => {
...
export default function Goals({ view = "client", client, }) {
  ...
  return (
    <>
      ...
      <AddNewGoal open={openAddNewGoal} onClose={handleCloseAddNewGoal} dispatch={dispatch} />
    </>
  );
}
