    ...
    return (
        <Container >
            ...
            <Paper elevation="6" style={{ padding: '5px 25px' }}>
                ...
                <Typography >Of course, BMR only gives us the calories that you burn at rest, so we still need to figure out how many more active calories you are burning to figure out your Total Energy Expenditure (TEE).
                    Fitness tracking watches are a great way to help figure out your TEE, but that doesn’t mean you need to have one.  Another way is to multiply your BMR with a range of different numbers depending on how active you are.</Typography>
                <br />
                {/*table*/}
                <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                <TableCell>Moderate Activity (Ex: Standing or walking job, 3 workouts per week)</TableCell>
                ...
                <br />
                <Typography >Using this system is a rough estimate, but with proper caloric and weight tracking, you will be able to figure out your average total energy expenditure (also known as maintenance level).</Typography>
                <Typography >Once we have this number we can use it to control our weight, lets use an example:</Typography>
                <Typography >	Jon wants to lose 10 pounds of body weight over a 10 week period. His BMR is 2000 Calories, he has a full-time desk job, and works out 0-1 times per week.

                    We would use the Sedentary calculation since Jon does not have a fitness tracker:
                    2000 * 1.1 = 2200 Calories
                    As you can see, Jon's average daily total energy expenditure is 2200 Calories. This means, with his current lifestyle, he should eat 2200 calories per day in order to maintain his weight; but he wants to lose 1 pound per week for the next 10 weeks, so he needs to eat less than this.

                    How much less?
                    Since Jon is trying to lose 1 pound per week, lets think of this on a weekly basis.  If you recall from before, its takes 3500 calories to lose 1 pound.
                    Jon needs to consume 3500 less calories than his total weekly expenditure, which is 15,400 calories (2200 daily average * 7 days in a week).
                    This means he would need to eat 11,900 calories over the course of the week, or 1700 calories per day and he should lose one pound per week.

                    To make the numbers easier to look at, simply think of 1 pound per week is being in a 500 calorie deficit from your daily TEE (3500cal / 7 Days = 500cal)
                </Typography>
            </Paper>
        </Container>
    )
