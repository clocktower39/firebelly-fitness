...
const trainingFields = {
  ...
  pilates: Joi.object().unknown(true).optional(),
...
router.post('/trainingByIds', verifyAccessToken, trainingController.get_training_by_ids);
...
router.post('/exerciseRecords', verifyAccessToken, trainingController.get_exercise_records);
